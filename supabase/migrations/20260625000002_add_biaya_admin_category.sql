-- Migration: 20260625000002_add_biaya_admin_category
-- Purpose: Add 'Biaya Admin' to default expense categories for new trackers
...
BEGIN
  ...
  INSERT INTO public.categories (tracker_id, name, type, icon, color, is_default) VALUES
    ...
    (NEW.id, 'Biaya Admin',    'expense', 'receipt',     '#E8E8E8', true);
